...
;; ;; 1. 英文字体 (等宽)
;; ;; ----------------------------
;; (setq doom-font (font-spec :family "Fira Code" :size my-font-size :weight 'normal)
;;       doom-variable-pitch-font doom-font) ;; 全部用等宽字体

;; ;; ----------------------------
;; ;; 2. 中文等宽字体
;; ;; ----------------------------
;; (dolist (charset '(kana han cjk-misc bopomofo))
;;   (set-fontset-font t charset (font-spec :family "Noto Sans Mono CJK SC" :size my-font-size) nil 'prepend))
...
;;       `(("Noto Sans Mono CJK SC" . 1.0)   ;; 中文不放大，等宽
;;         ("Fira Code" . 1.0)
;;         ("JetBrains Mono" . 1.0)
...
;; ----------------------------
(dolist (charset '(kana han cjk-misc bopomofo))
  (set-fontset-font t charset (font-spec :family "Sarasa Mono SC" :size my-font-size :weight 'semi-bold) nil 'prepend))
...
;; 按 <leader> f e 就会直接在 Explorer 中打开当前文件所在目录，并选中文件
